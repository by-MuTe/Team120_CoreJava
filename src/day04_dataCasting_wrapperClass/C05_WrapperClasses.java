...
public class C05_WrapperClasses {
    ...
    public static void main(String[] args) {
        ...
        /*
           ...
           ANCAK primitive data turleri icin de hazir method'lar kullanabilecek
        ...
        // Wrapper class'lar arasinda casting OLMAZ
        ...
        System.out.println("====");
        System.out.println(Integer.valueOf(str1) + Integer.valueOf(str2)); // 55
        ...
        String knt= "false";
        boolean kntsnc= Boolean.valueOf(knt);
        System.out.println(kntsnc);
